...
- 👯 My first big challenge: I and a small friend group developed a website using React, Java, Google Cloud, and RabbitMQ. The website uses queues to send different messages to the microservices (repositories are called Account_microservice and Transaction_microservice). You are welcome to explore my GitHub repositories ;)
